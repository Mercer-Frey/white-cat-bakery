...
<?php
$conn = connect();
$good_data = selectRows($conn, "SELECT * FROM cheesecakes_price");
$good_count = selectOneRow($conn, "SELECT COUNT(*) FROM cheesecakes_price");
close($conn);
?>
			...
			<div class="block-content d-flex justify-content-between pt-2">
				<div class="main-container">
                    ...
                    <?php
                        ...
                        for ($i=0; $i < count($good_data); $i++) { 
                            $out .= '       
								...
								<div class="item-good d-flex align-items-center">
									<a href="#" data-good-id="'.$good_data[$i]['id'].'" data-category="cheesecakes_price" data-image1="'.$good_data[$i]['image_1'].'" data-image2="'.$good_data[$i]['image_2'].'" id="delete_good">
									...
									<img src="../img/cheesecakes/'.$good_data[$i]['image_1'].'" alt="">
									<p class="m-0 p-0">'.$good_data[$i]['name'].'</p>
									<div class="d-flex price-block">
										<span>'.$good_data[$i]['cost'].'</span>
										<a href="edit_good.php?good_id='.$good_data[$i]['id'].'&good_category=cheesecakes_price&folder=cheesecakes" class="edit-good-btn center">Edit</a>									
									</div>
								</div>
                        ...
                        echo $out;
                    ?>  
					<a href="add_good.php?category=cheesecakes_price" class="btn-video mt-2 d-block add-good-btn" data-category="cheesecakes_price">Add good</a>
				</div>
			</div>
		</div>
	</div>
